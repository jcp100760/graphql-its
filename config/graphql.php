...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                // ExampleQuery::class,
                App\GraphQL\Queries\ProffessorsQuery::class,
                App\GraphQL\Queries\MattersQuery::class,
                App\GraphQL\Queries\GroupsQuery::class,
                App\GraphQL\Queries\TurnsQuery::class,
                ...
                App\GraphQL\Queries\SpecialtiesQuery::class,
            ],
            'mutation' => [
                // ExampleMutation::class,
                //  Creacion de Registros
               App\GraphQL\Mutations\CreateTurn::class,
               App\GraphQL\Mutations\CreateProffessor::class,
               App\GraphQL\Mutations\CreateSpecialty::class,
               App\GraphQL\Mutations\CreateMg::class,
               App\GraphQL\Mutations\CreateMatter::class,
               ...
               App\GraphQL\Mutations\UpdateSpecialty::class,
               App\GraphQL\Mutations\UpdateProffessor::class,
               App\GraphQL\Mutations\UpdateMatter::class,
               App\GraphQL\Mutations\UpdateTurn::class,
               App\GraphQL\Mutations\UpdateMg::class,
               App\GraphQL\Mutations\UpdateGroup::class,
               App\GraphQL\Mutations\UpdateGmp::class,

                //  Borrado de Registros
                App\GraphQL\Mutations\DeleteTurn::class,
                App\GraphQL\Mutations\DeleteSpecialty::class,
                App\GraphQL\Mutations\DeleteProffessor::class,
                App\GraphQL\Mutations\DeleteMg::class,
                App\GraphQL\Mutations\DeleteMatter::class,
                App\GraphQL\Mutations\DeleteGroup::class,
                App\GraphQL\Mutations\DeleteGmp::class,
                App\GraphQL\Mutations\DeleteAbsence::class,
            ],
            // The types only available in this schema
            'types' => [
                // ExampleType::class,
                App\GraphQL\Types\ProffessorType::class,
                App\GraphQL\Types\MatterType::class,
                App\GraphQL\Types\GroupType::class,
                App\GraphQL\Types\TurnType::class,
                App\GraphQL\Types\MgType::class,
                App\GraphQL\Types\SpecialtyType::class,
                App\GraphQL\Types\HelloType::class,
